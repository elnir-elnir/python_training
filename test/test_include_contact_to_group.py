...
#test_include_modified_contact_in_custom_group_via_home
...
#test_include_modified_contact_in_multiple_groups_sequentially_via_home
...
#test_reinclude_modified_contact_in_group_after_exclusion_via_home
